...
public sealed class UserConfiguration : IEntityTypeConfiguration<User>
{
    public void Configure(EntityTypeBuilder<User> builder)
    {
        ...
        builder.Property(x => x.Id).HasStronglyTypedIdConversion(x => UserId.From(x));

        builder
            .Property(x => x.Email)
            .HasValueObjectConversion(e => e.Value, value => Email.Create(value))
            .HasMaxLength(255)
            .IsRequired();
        ...
        builder
            ...
            .HasValueObjectConversion(u => u.Value, value => Username.Create(value))
            .HasMaxLength(50)
            .IsRequired();
        ...
        builder
            ...
            .HasValueObjectConversion(p => p.Value, value => PasswordHash.From(value))
            .IsRequired();
